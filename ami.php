...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark" id="mainNav">
            <div class="container-fluid">
                <a  href="index.html"><img  src="assets/ucm.png"  alt="" /></a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ml-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link js-scroll-trigger dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                Appel d'offre
                            </a>
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="ami.php">Marché en cours</a></li>
                                <li><a class="dropdown-item" href="marche_clôture.php">Marché clôturé</a></li>
                                <li><a class="dropdown-item" href="attribution.php">Attribution du marché</a></li>
                            </ul>
                        </li>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="contact.php">Contact-Nous</a></li>
                    </ul>                        
        </nav>
      <!--Tableau Ami-->
  ...
  <tbody>
    <tr>
      ...
      <td>
        <span class="badge badge-success rounded-pill d-inline"><?php echo date('d/m/Y à H\hi',$donnees['timestamp']); ?></span>
      </td>
